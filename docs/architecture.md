...
| `detectLosEvents` (**P2.2**, PR #89 detector-slice) | contador `LOS_SECONDS_TOTAL` creciendo 24 h | Δ ≥ 1 s → warning; Δ ≥ 30 s → critical; `minSamples: 3` |
