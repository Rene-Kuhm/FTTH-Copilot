...
- [x] F-4.1 RED: corpus-loader test (zod rejection + stable-ID dedup); GREEN: implement
...
- [x] F-4.2 RED: runner test (keyless execution, same seam); GREEN: implement
...
- [x] F-4.3 RED: assertions test (per-gate + pink observability-only); GREEN: implement
...
- [x] F-4.4 RED: metrics test (coverage / abstention / FP / TBD precision); GREEN: implement
